...
import org.example.aok.core.DatePickerComponent
...
fun ReportForm(
    ...
    ModalBottomSheet(
        ...
        Column (
            ...
            val form = org.example.aok.data.network.ReportForm(
            ...
            Row (
                ...
                MyFilledTonalButton(
                    ...
                    onClickAction = {
//                        reportesViewModel.run(form, homeViewModel)
//                        homeViewModel.onloadReport(form)
                        homeViewModel.openURL("https://sga.itb.edu.ec/media//documentos/userreports/default/cumpleanios_estudiantes20250318_175713.pdf")
                    }
                )
            }
        }
